...
Robot.plotopt = {'floorlevel', 1, 'workspace', [-20, 60, -20, 40, -5, 5], 'reach', 10};
...
%     pause(1);
  ...
  T_transf = Robot.fkine(T_1); % matriz de transformação de resultante dos novos thetas e das novas velocidades de juntas
  
  theta_atual = theta111+theta333 + pi * 0.1; 
  theta_des = theta_desejado(1)+theta_desejado(3);       
  
  vx = ( T_transf.t(1,1) - 40)/0.1;                                                 
  vy = ( T_transf.t(2,1) - 20)/0.1;                                                
  wz = ( theta_atual - theta_des)/0.1;                                       
